(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["RgbDiv"] = factory(require("react"), require("styled-components"));
	else
		root["RgbDiv"] = factory(root["React"], root["styled-components"]);
...
var Div = function (_Component) {
  ...
  function Div(props) {
    ...
    _this.state = {
      Div: __WEBPACK_IMPORTED_MODULE_1_styled_components___default.a.div(_templateObject, props.css)
    };
    return _this;
  }
  ...
  _createClass(Div, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.css !== this.props.css) {
        this.setState({
          Div: __WEBPACK_IMPORTED_MODULE_1_styled_components___default.a.div(_templateObject, nextProps.css)
        });
      }
    }
  }, {
...
Div.propTypes = {
  css: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  children: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.children
};
Div.defaultProps = {
